...
- [ ] `tests/test_phase6_source_execution.py` freezes the exact four-workflow source-only grammar and every forbidden acquisition/invocation/order mutation before the Plan 06-05 verifier turns it green.
